...
/** Log in an existing customer with email/password. */
...
/** Send a password-reset email via Firebase Auth (no custom storage involved). */
...
/** Change the logged-in user's password via Firebase Auth (requires recent login). */
...
/** Get the current user synchronously (null if auth state not yet resolved or logged out). */
